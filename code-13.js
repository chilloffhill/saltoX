...
const calcData = () => {
    let locCustomPoolSize = customPoolSize.value*1;
    ...
    const shareCapitalOp1 = companyOptions1 / locShares;
    const shareCapitalOp2 = companyOptions2 / locShares;
    const shareCapitalOp3 = companyOptions3 / locShares;
