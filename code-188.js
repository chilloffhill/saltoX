const myChart = echarts.init(document.getElementById('lineGraph'));
const myChart2 = echarts.init(document.getElementById('lineGraph2'));
const myChart3 = echarts.init(document.getElementById('lineGraph3'));
...
const salaryDifferenceSubLabelOp1 = document.getElementById("salary-difference-sub-label-op1");
const salaryDifferenceSubLabelOp3 = document.getElementById("salary-difference-sub-label-op3");

let salaryDifferenceSavedOp1 = salaryDifferenceOp1.value;
let salaryDifferenceSavedOp2 = salaryDifferenceOp2.value;
let salaryDifferenceSavedOp3 = salaryDifferenceOp3.value;

let customSalaryDifferenceSavedOp1 = customSalaryDifferenceOp1.value;
let customSalaryDifferenceSavedOp2 = customSalaryDifferenceOp2.value;
let customSalaryDifferenceSavedOp3 = customSalaryDifferenceOp3.value;
...
const calcData = () => {
    ...
    if (salaryDifferenceOp1.value === 'custom') {
        ...
        locSalaryDifferenceOp1 = customSalaryDifferenceOp1.value === '' ? 90 : customSalaryDifferenceOp1.value.replace(/[^0-9.]/g, '')*1;
    } else{
        customSalaryDifferenceOp1.style.display = 'none';
        customSalaryDifferenceOp1.value = '';
        locSalaryDifferenceOp1 = salaryDifferenceOp1.value === '' ? 90 : salaryDifferenceOp1.value*1;
    }
    ...
    if (salaryDifferenceOp3.value === 'custom') {
        ...
        locSalaryDifferenceOp3 = customSalaryDifferenceOp3.value === '' ? 110 : customSalaryDifferenceOp3.value.replace(/[^0-9.]/g, '')*1;
    } else{
        customSalaryDifferenceOp3.style.display = 'none';
        customSalaryDifferenceOp3.value = '';
        locSalaryDifferenceOp3 = salaryDifferenceOp3.value === '' ? 110 : salaryDifferenceOp3.value*1;
    }
    ...
    let grossSalaryOp1 = ( locAnnualGrossSalary * locSalaryDifferenceOp1 ) / 100;
    let grossSalaryOp2 = ( locAnnualGrossSalary  * locSalaryDifferenceOp2 ) / 100;
    let grossSalaryOp3 = ( locAnnualGrossSalary * locSalaryDifferenceOp3 ) / 100;
    ...
    let companyOptions3 = ( ( ( locAnnualGrossSalary + ( companyOptions2 * ( totalValueOfOption / numberOfShares ) ) / 4) - ( locAnnualGrossSalary * locSalaryDifferenceOp3 ) / 100 ) * 4 ) / ( totalValueOfOption / numberOfShares );
    ...
    const totalAnnualComp1 = ( locAnnualGrossSalary * locSalaryDifferenceOp1 ) / 100 + ( ( ( totalAnnualComp2 - ( locAnnualGrossSalary * locSalaryDifferenceOp1 ) / 100 ) * 4 ) / 4 )
    const totalAnnualComp3 = ( locAnnualGrossSalary * locSalaryDifferenceOp3 ) / 100 + ( ( ( totalAnnualComp2 - ( locAnnualGrossSalary * locSalaryDifferenceOp3 ) / 100 ) * 4 ) / 4 )
    ...
    let grossSalaryVSOPOp1 = ( locAnnualGrossSalary * locSalaryDifferenceOp1 ) / 100;
    let grossSalaryVSOPOp2 = ( locAnnualGrossSalary * locSalaryDifferenceOp2 ) / 100;
    let grossSalaryVSOPOp3 = ( locAnnualGrossSalary * locSalaryDifferenceOp3 ) / 100;
    ...
    if ( companyOptions1 < 0 ){
        ...
        salaryDifferenceSavedOp1 = salaryDifferenceOp1.value
        customSalaryDifferenceSavedOp1 = customSalaryDifferenceOp1.value
        salaryDifferenceLabelOp1.style.display = 'none';
        salaryDifferenceSubLabelOp1.style.display = 'flex';
    ...
    if ( companyOptions3 < 0 ){
        ...
        salaryDifferenceSavedOp3 = salaryDifferenceOp3.value
        customSalaryDifferenceSavedOp3 = customSalaryDifferenceOp3.value
        salaryDifferenceLabelOp3.style.display = 'none';
        salaryDifferenceSubLabelOp3.style.display = 'flex';
    ...
    const parentElement = document.getElementById('w-dropdown-list-6');
    if (parentElement) {
        const childElements = parentElement.querySelectorAll('*');

        childElements.forEach(element => {
            console.log(salaryDifferenceSavedOp3);
            if (element.textContent.trim() === salaryDifferenceSavedOp3 + '%' ) {
                element.style.color = '#7564f2';
            }else{
                element.style.color = '#1f1f2d';
            }
            if ( salaryDifferenceSavedOp3 === 'custom' && element.textContent.trim() === 'Custom'){
                element.style.color = '#7564f2';
            }
        });
    }
